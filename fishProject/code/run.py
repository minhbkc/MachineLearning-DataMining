...
seed(1)
filename = '/content/gdrive/MyDrive/fistProject/dat/Fish.csv'
...
start = time.time()
model = knn.K_Nearest_Neighbors_Classifier(K=bestK)
model.fit(X_train, y_train)
model1 = KNeighborsClassifier(n_neighbors=bestK)
model1.fit(X_train, y_train)
